...
$wp_customize->add_control ( new WP_Customize_Color_Control( $wp_customize, 'site_title_identity_color',
	array(
		'label'    => __( 'Site Title/Tagline Color', 'seek' ),
...
$wp_customize->add_control('show_selected_page_content_on_homepage',
    array(
        'label' => esc_html__('Enable Static Page Content on Home/Front Page', 'seek'),
        'section' => 'static_front_page',
        'type' => 'checkbox',
        'priority' => 100,
		'active_callback' => 'seek_blog_section_callback',
    )
);
...
$wp_customize->add_control('show_latest_post_content_on_homepage',
    array(
        'label' => esc_html__('Enable Latest Post on Home/Front Page', 'seek'),
        'section' => 'static_front_page',
        'type' => 'checkbox',
        'priority' => 100,
		'active_callback' => 'seek_homepage_section_callback',
    )
);
...
$wp_customize->add_panel( 'homepage_option_panel',
	array(
		'title'      => esc_html__( 'HomePage Setting Options', 'seek' ),
		'priority'   => 200,
		'capability' => 'edit_theme_options',
	)
);
...
$wp_customize->add_section( 'theme_option_section_settings',
	array(
		'title'      => esc_html__( 'Layout Management', 'seek' ),
		'priority'   => 100,
		'capability' => 'edit_theme_options',
...
$wp_customize->add_control( 'site_date_layout_option',
	array(
		'label'    => esc_html__( 'Select Date Format', 'seek' ),
		'section'  => 'theme_option_section_settings',
		'choices'  => array(
                'in-time-span' => __( 'Time Span Format', 'seek' ),
                'normal-format' => __( 'Regular Format', 'seek' ),
		    ),
		'type'     => 'select',
		'priority' => 160,
	)
...
$wp_customize->add_control( 'homepage_layout_option',
	array(
		'label'    => esc_html__( 'Site Layout', 'seek' ),
		'section'  => 'theme_option_section_settings',
		'choices'  => array(
                'full-width' => __( 'Full Width', 'seek' ),
                'boxed' => __( 'Boxed', 'seek' ),
		    ),
		'type'     => 'select',
		'priority' => 160,
...
$wp_customize->add_control( 'global_layout',
	array(
		'label'    => esc_html__( 'Global Sidebar Layout', 'seek' ),
		'section'  => 'theme_option_section_settings',
		'choices'   => array(
			'left-sidebar'  => esc_html__( 'Primary Sidebar - Content', 'seek' ),
			'right-sidebar' => esc_html__( 'Content - Primary Sidebar', 'seek' ),
			'no-sidebar'    => esc_html__( 'No Sidebar', 'seek' ),
			),
		'type'     => 'select',
		'priority' => 170,
	)
...
$wp_customize->add_control( 'excerpt_length_global',
	array(
		'label'    => esc_html__( 'Set Global Archive Length', 'seek' ),
		'section'  => 'theme_option_section_settings',
		'type'     => 'number',
		'priority' => 175,
...
$wp_customize->add_section('mailchimp_section_pupup',
    array(
        'title' => esc_html__('Mailchimp Subscription Options', 'seek'),
        'priority' => 100,
        'capability' => 'edit_theme_options',
        'panel' => 'theme_option_panel',
    )
...
$wp_customize->add_control('enable_mailchimp_suscription',
    array(
        'label' => __('Enable Mailchimp Subscription', 'seek'),
        'section' => 'mailchimp_section_pupup',
        'type' => 'checkbox',
        'priority' => 100,
    )
);
...
$wp_customize->add_control( 'mailchimp_suscription_title',
	array(
	'label'    => __( 'Mailchimp Subscription Title', 'seek' ),
	'section'  => 'mailchimp_section_pupup',
	'type'     => 'text',
	'priority' => 100,
	)
...
$wp_customize->add_control( 'mailchimp_suscription_shortcode',
	array(
	'label'    => __( 'Mailchimp Subscription Shortcode', 'seek' ),
	'section'  => 'mailchimp_section_pupup',
	'type'     => 'text',
	'priority' => 100,
	)
...
$wp_customize->add_section('single_page_section_Settings',
    array(
        'title' => esc_html__('Single Post/page Section Options', 'seek'),
        'priority' => 100,
        'capability' => 'edit_theme_options',
        'panel' => 'theme_option_panel',
    )
...
$wp_customize->add_control('enable_except_on_single_post',
    array(
        'label' => esc_html__('Enable Excerpt on Single Post/page', 'seek'),
...
$wp_customize->add_control('enable_authro_detail_single_page',
    array(
        'label' => esc_html__('Enable Author Details on Single Post/page', 'seek'),
        'section' => 'single_page_section_Settings',
        'type' => 'checkbox',
        'priority' => 100,
    )
...
$wp_customize->add_control('enable_related_post_on_single_page',
    array(
        'label' => esc_html__('Enable Related Post on Single Post/page', 'seek'),
        'section' => 'single_page_section_Settings',
        'type' => 'checkbox',
        'priority' => 100,
    )
...
$wp_customize->add_control( 'single_related_post_title',
	array(
	'label'    => __( 'Title for Single Post/page Related Post', 'seek' ),
	'section'  => 'single_page_section_Settings',
	'type'     => 'text',
	'priority' => 100,
	)
...
$wp_customize->add_control('number_of_single_related_post',
    array(
        'label'       => esc_html__('Select no of Related Post (max-6)', 'seek'),
        'section'     => 'single_page_section_Settings',
        'type'        => 'number',
        'priority'    => 110,
...
$wp_customize->add_control( 'pagination_type',
	array(
	'label'       => __( 'Pagination Type', 'seek' ),
	'section'     => 'pagination_section',
	'type'        => 'select',
	'choices'               => array(
		'default' => __( 'Default (Older / Newer Post)', 'seek' ),
		'numeric' => __( 'Numeric', 'seek' ),
	    ),
	'priority'    => 100,
	)
);
...
$wp_customize->add_control( 'number_of_footer_widget',
	array(
	'label'    => __( 'Number Of Footer Widget', 'seek' ),
	'section'  => 'footer_section',
	'type'     => 'select',
	'priority' => 100,
	'choices'               => array(
		0 => __( 'Disable footer sidebar area', 'seek' ),
		1 => __( '1', 'seek' ),
		2 => __( '2', 'seek' ),
		3 => __( '3', 'seek' ),
		4 => __( '4', 'seek' ),
...
$wp_customize->add_control( 'copyright_text',
	array(
	'label'    => __( 'Footer Copyright Text', 'seek' ),
	'section'  => 'footer_section',
	'type'     => 'text',
	'priority' => 120,
	)
...
$wp_customize->add_section( 'breadcrumb_section',
	array(
	'title'      => __( 'Breadcrumb Options', 'seek' ),
	'priority'   => 120,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'breadcrumb_type',
	array(
	'label'       => __( 'Breadcrumb Type', 'seek' ),
	'description' => sprintf( __( 'Advanced: Requires %1$sBreadcrumb NavXT%2$s plugin', 'seek' ), '<a href="https://wordpress.org/plugins/breadcrumb-navxt/" target="_blank">','</a>' ),
	'section'     => 'breadcrumb_section',
	'type'        => 'select',
	'choices'               => array(
		'disabled' => __( 'Disabled', 'seek' ),
		'simple' => __( 'Simple', 'seek' ),
		'advanced' => __( 'Advanced', 'seek' ),
	    ),
	'priority'    => 100,
	)
);
...
$wp_customize->add_section('enable_preloader_option',
    array(
        'title' => __('Preloader Options', 'seek'),
        'priority' => 120,
        'capability' => 'edit_theme_options',
        'panel' => 'theme_option_panel',
    )
...
$wp_customize->add_control('enable_preloader',
    array(
        'label' => __('Enable Preloader', 'seek'),
